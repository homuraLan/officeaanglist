...
# qbittorrent-nox
docker run --name qbittorrent-nox --env-file .env -p 6901:6901/tcp -p 6881:6881/tcp -p 6881:6881/udp -v "/path/to/qbittorrent/config:/config" -v "/path/to/Download/qbittorrent:/downloads" --network officeaanglist qbittorrentofficial/qbittorrent-nox:latest
